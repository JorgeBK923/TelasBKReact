< !DOCTYPE html >
    <html class="light" lang="en"><head>
        ...
        <title>BugKillers Settings &amp; Integrations</title>
            ...
            <div class="flex flex-1 overflow-hidden">
                <aside class="w-64 flex-none bg-white dark:bg-card-dark border-r border-slate-200 dark:border-white/10 flex flex-col justify-between py-6 hidden md:flex transition-colors duration-300">
                    <nav class="flex flex-col gap-1">
                        ...
                        <a class="flex items-center gap-3 pl-[20px] pr-4 py-3 bg-primary-light dark:bg-primary/20 border-l-[4px] border-primary text-slate-900 dark:text-white transition-colors" href="#">
                            <span class="material-symbols-outlined text-[20px] text-primary">extension</span>
                ...
                <main class="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-4 md:p-8 lg:px-12 transition-colors duration-300">
                    <div class="md:hidden flex overflow-x-auto pb-2 gap-2 no-scrollbar mb-6 -mx-4 px-4">
                        ...
                        <a class="flex-none px-4 py-2 bg-primary text-white rounded-full text-sm font-semibold whitespace-nowrap" href="#">Integrações</a>
                    </div>
                    <div class="max-w-5xl mx-auto flex flex-col gap-6">
                        ...
                        <div class="flex justify-between items-end gap-4 mt-2">
                            <div class="flex flex-col gap-1">
                                <h3 class="text-xl font-bold text-slate-900 dark:text-white">Ferramentas Conectadas</h3>
                                <p class="text-slate-500 dark:text-slate-400 text-sm">Gerencie suas integrações e sincronização de dados.</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div class="bg-white dark:bg-card-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-white/5 flex flex-col h-full animate-fade-in-up" style="animation-delay: 0ms;">
                                <div class="flex justify-between items-start mb-4">
                                    <div class="size-12 rounded-lg bg-[#0052CC] flex items-center justify-center text-white shadow-lg shadow-blue-900/20">
                                        <span class="material-symbols-outlined text-2xl">view_kanban</span>
                                    </div>
                                    <div class="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-green-50 dark:bg-green-500/10 border border-green-100 dark:border-green-500/20">
                                        <div class="size-1.5 rounded-full bg-green-500 animate-pulse"></div>
                                        <span class="text-[10px] font-bold text-green-700 dark:text-green-400 uppercase tracking-wide">Conectado</span>
                                    </div>
                                </div>
                                <div class="mb-6">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white mb-1">Jira Cloud</h4>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">Tech Startup XYZ</p>
                                </div>
                                <div class="grid grid-cols-2 gap-4 mb-6 pt-6 border-t border-slate-100 dark:border-white/5">
                                    <div>
                                        <p class="text-xs text-slate-400 mb-1">Projetos</p>
                                        <p class="font-bold text-slate-900 dark:text-white">8</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-slate-400 mb-1">Cenários</p>
                                        <p class="font-bold text-slate-900 dark:text-white">247</p>
                                    </div>
                                </div>
                                <div class="flex gap-3 mt-auto">
                                    <button class="flex-1 px-3 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 text-xs font-bold hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">Configurar</button>
                                    <button class="px-3 py-2 rounded-lg border border-transparent text-red-600 dark:text-red-400 text-xs font-bold hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">Desconectar</button>
                                </div>
                            </div>
                            <div class="bg-white dark:bg-card-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-white/5 flex flex-col h-full animate-fade-in-up" style="animation-delay: 100ms;">
                                <div class="flex justify-between items-start mb-4">
                                    <div class="size-12 rounded-lg bg-[#0078D7] flex items-center justify-center text-white shadow-lg shadow-blue-900/20">
                                ...
                                <div class="mb-6">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white mb-1">Azure DevOps</h4>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">mycompany</p>
                                </div>
                                <div class="grid grid-cols-2 gap-4 mb-6 pt-6 border-t border-slate-100 dark:border-white/5">
                                    <div>
                                        <p class="text-xs text-slate-400 mb-1">Projetos</p>
                                        <p class="font-bold text-slate-900 dark:text-white">4</p>
                                    </div>
                                    <div>
                                        <p class="text-xs text-slate-400 mb-1">Planos Teste</p>
                            ...
                            <div class="bg-white dark:bg-card-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-white/5 flex flex-col h-full animate-fade-in-up" style="animation-delay: 200ms;">
                                <div class="flex justify-between items-start mb-4">
                                    <div class="size-12 rounded-lg bg-[#4A154B] flex items-center justify-center text-white shadow-lg shadow-purple-900/20">
                                        <span class="material-symbols-outlined text-2xl">forum</span>
                                    </div>
                                    <div class="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10">
                                        <div class="size-1.5 rounded-full bg-slate-400"></div>
                                        <span class="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wide">Disponível</span>
                                    </div>
                                </div>
                                <div class="mb-6">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white mb-1">Slack</h4>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">Notificações em tempo real</p>
                                </div>
                                <div class="flex-1 flex items-center mb-6 pt-6 border-t border-slate-100 dark:border-white/5">
                                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Receba alertas de bugs críticos e atualizações de status diretamente no canal da sua equipe.</p>
                                </div>
                                <div class="flex gap-3 mt-auto">
                                    <button class="w-full px-3 py-2 rounded-lg bg-primary hover:bg-blue-700 text-white text-xs font-bold transition-colors shadow-sm shadow-blue-500/20">Conectar</button>
                                </div>
                            </div>
                            <div class="bg-white dark:bg-card-dark rounded-xl p-6 shadow-sm border border-slate-200 dark:border-white/5 flex flex-col h-full animate-fade-in-up" style="animation-delay: 300ms;">
                                <div class="flex justify-between items-start mb-4">
                                    <div class="size-12 rounded-lg bg-[#FF6C37] flex items-center justify-center text-white shadow-lg shadow-orange-900/20 opacity-80 grayscale-[0.5]">
                                        <span class="material-symbols-outlined text-2xl">rocket_launch</span>
                                    </div>
                                    <div class="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10">
                                        <span class="material-symbols-outlined text-[12px] text-slate-500">lock</span>
                                        <span class="text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wide">Em Breve</span>
                                    </div>
                                </div>
                                <div class="mb-6 opacity-75">
                                    <h4 class="text-lg font-bold text-slate-900 dark:text-white mb-1">Postman</h4>
                                    <p class="text-sm text-slate-500 dark:text-slate-400">Sincronização de APIs</p>
                                </div>
                                <div class="flex-1 flex items-center mb-6 pt-6 border-t border-slate-100 dark:border-white/5 opacity-75">
                                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">Em breve você poderá importar coleções e gerar testes automáticos a partir da documentação.</p>
                                </div>
                                <div class="flex gap-3 mt-auto">
                                    <button class="w-full px-3 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 text-xs font-bold hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">Me Notifique</button>
                                </div>
                            </div>
                            <button class="group bg-slate-50 dark:bg-white/5 rounded-xl p-6 border-2 border-dashed border-slate-300 dark:border-white/10 flex flex-col items-center justify-center h-full min-h-[280px] hover:border-primary dark:hover:border-primary hover:bg-slate-100 dark:hover:bg-white/10 transition-all duration-300 animate-fade-in-up" style="animation-delay: 400ms;">
                                <div class="size-14 rounded-full bg-white dark:bg-white/10 group-hover:bg-primary group-hover:text-white border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-400 mb-4 transition-all duration-300 shadow-sm">
                                    <span class="material-symbols-outlined text-3xl">add</span>
                                </div>
                                <h4 class="text-sm font-bold text-slate-900 dark:text-white mb-1 group-hover:text-primary transition-colors">Adicionar Nova Integração</h4>
                                <p class="text-xs text-slate-500 dark:text-slate-400 text-center max-w-[200px] group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors">Explore a galeria de plugins ou solicite uma conexão customizada.</p>
                            </button>
                        </div>
